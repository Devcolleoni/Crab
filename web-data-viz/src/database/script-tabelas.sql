...
CREATE TABLE matriz(
    ...
    cep CHAR(9) null,
    codigo_ativacao VARCHAR(10) null UNIQUE
    );
...
UPDATE usuario 
SET senha = 'EDK001' 
WHERE cpf = '122.121.121-12' 
  AND id_usuario > 0;


SELECT senha FROM usuario WHERE email = 'Zaira@gmail.com';

ALTER TABLE setor ADD COLUMN id_filial INT;
ALTER TABLE setor ADD COLUMN id_matriz INT;

ALTER TABLE setor ADD CONSTRAINT fk_setor_filial
    FOREIGN KEY (id_matriz, id_filial) REFERENCES filial (id_matriz, id_filial);